...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => 'https://github.com/aerogear/aerogear-ios.git', :commit => '064b5eb7ded9ce7fa96bb03761f8aaf50ed53c1c' }
  s.platform     = :ios
  s.source_files = 'AeroGear-iOS/AeroGear-iOS/**/*.{h,m}'
  s.public_header_files = 'AeroGear-iOS/AeroGear-iOS/AeroGear.h', 'AeroGear-iOS/AeroGear-iOS/config/AGConfig.h', 'AeroGear-iOS/AeroGear-iOS/pipeline/AGPipe.h', 'AeroGear-iOS/AeroGear-iOS/pipeline/AGPipeline.h', 'AeroGear-iOS/AeroGear-iOS/pipeline/AGPipeConfig.h', 'AeroGear-iOS/AeroGear-iOS/pipeline/AGFilterConfig.h', 'AeroGear-iOS/AeroGear-iOS/pipeline/AGNSArray+Paging.h', 'AeroGear-iOS/AeroGear-iOS/datamanager/AGStore.h', 'AeroGear-iOS/AeroGear-iOS/datamanager/AGDataManager.h', 'AeroGear-iOS/AeroGear-iOS/datamanager/AGStoreConfig.h', 'AeroGear-iOS/AeroGear-iOS/security/AGAuthenticationModule.h', 'AeroGear-iOS/AeroGear-iOS/security/AGAuthenticator.h', 'AeroGear-iOS/AeroGear-iOS/security/AGAuthConfig.h'
  s.requires_arc = true
