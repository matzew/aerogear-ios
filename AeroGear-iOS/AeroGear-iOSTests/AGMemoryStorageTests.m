...
-(void) testSaveAutoGeneratedId {
    ...
    [_memStore save:user success:^(id object) {
        STAssertNotNil(object, @"object should not be nil");
        STAssertNotNil([object valueForKey:@"id"], @"object should not be nil");
    } failure:^(NSError *error) {
        STFail(@"save should not fail");
    }];
}
...
-(void) testSaveWithNoIdAndCustomIdSetting {
    ...
    [_memStore save:user success:^(id object) {
        STAssertNotNil(object, @"object should not be nil");
        STAssertNotNil([object valueForKey:@"myId"], @"object should not be nil");
    } failure:^(NSError *error) {
        STFail(@"save should not fail");
    }];
}
...
-(void) testRemove {
    ...
    // remove it
    [_memStore remove:user success:^(id object) {
        STAssertNotNil(object, @"object should not be nil");
    } failure:^(NSError *error) {
...
-(void) testRemoveNonExisting {
    ...
    [_memStore remove:noUser success:^(id object) {
        STAssertNil(object, @"object should be nil");
    } failure:^(NSError *error) {
        STFail(@"remove should not fail");
    }];
